...
import { whatsappLink, DEFAULT_WA_MESSAGE, PHONE_NUMBER } from '@/lib/constants';
  ...
  return (
    ...
    >
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-4 bg-success text-white font-semibold text-sm active:brightness-90 transition-all"
      ...
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-4 bg-gold text-bg-primary font-semibold text-sm active:brightness-90 transition-all"
        aria-label="Call us"
      >
        <PhoneIcon />
        Call Now
